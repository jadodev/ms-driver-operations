 ...
 */
export class CreateDriverStatusDto {
  driverId: string;
  vehicleType: string;
  ...
  constructor(data: {
    ...
    if (!data.vehicleType) throw new Error("vehicleType is required.");
    ...
    if (!data.currentLocation) throw new Error("currentLocation is required.");
    ...
    if (!data.transportState) throw new Error("transportState is required.");
    if (!data.longCoordinate) throw new Error("longCoordinate is required.");
    if (!data.latCoordinate) throw new Error("latCoordinate is required.");
